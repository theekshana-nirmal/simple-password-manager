...
/**
 * This file contains the EncryptionUtils utility class for encrypting and decrypting password data.
 * OOP Concept: This class demonstrates the UTILITY pattern by providing static methods for encryption operations.
 */
public class EncryptionUtils {
    ...
    // Encrypts a plaintext password and returns a Base64-encoded string with IV prepended
    ...
    public static boolean isEncrypted(String str) {
        ...
        try {
            ...
            // If it successfully decodes and is longer than basic encryption overhead (IV + minimal content)
